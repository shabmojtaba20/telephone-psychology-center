...
const homepageCss='<link rel="stylesheet" href="/stage7-homepage.css?v=1">';
...
if(fs.existsSync(adminPath)){
 ...
 for(const s of [roleScript,roleSwitcher,routeGuard,panelIntegration,logoutFix,mediaUi,branding,theme,homepageManager])if(!html.includes(s))html=html.replace('</body>',`\n${s}\n</body>`);
...
console.log('Role routing, multi-role switcher, specialist-panel integration, consultant AI summary, Stage 5 media manager, dynamic center branding/logo, Stage 6 live theme/background controls, Stage 7 professional homepage manager, homepage ordering/visibility and gallery injected');
